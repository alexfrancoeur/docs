...
sidebarTitle: 'Instant branching'
icon: 'code-branch'
---
...
<Frame>
<img src="/images/core-concepts/copy-on-write-diagram-1.png" alt="Copy-on-Write branching — initial state"/>
</Frame>
...
<Frame>
<img src="/images/core-concepts/copy-on-write-branching-2.png" alt="Copy-on-Write branch — new branch created"/>
</Frame>
...
<Frame>
<img src="/images/core-concepts/copy-on-write-branching-3.png" alt="Copy-on-Write branch — new branch created"/>
</Frame>
...
<Tip>
[Learn more about branch management in the CLI documentation](/documentation/cli/branch)
</Tip>