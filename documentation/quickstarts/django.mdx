...
Learn how to connect your Django application to Xata's PostgreSQL platform.  
Get started with Django and PostgreSQL for robust web applications.
...
2. `http://localhost:8000/api/orders/` 
